...
<script>
  ...
  // Grabfood platform_id as default
  const grabfoodPlatform = platformList.find(p => p.name.toLowerCase().includes('grabfood'));
  const platformId = grabfoodPlatform ? grabfoodPlatform.id : '';
