...
>
  ...
  <nav class="sidebar-nav">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-2.21 0-4 1.79-4 4v4h8v-4c0-2.21-1.79-4-4-4zm0-6a6 6 0 00-6 6v2h12V8a6 6 0 00-6-6z" />
    </svg>
    Transaksi
    ...
    {{-- Item Terjual --}}
<a href="#" class="{{ request()->routeIs('itemTerjual.*') ? 'active' : '' }}">
 <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
