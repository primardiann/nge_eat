...
<div class="flex items-center gap-2 text-sm">
    <!-- Tanggal Awal -->
    <div class="relative">
        <input id="startDateLaporan" type="text" placeholder="Dari" readonly
    ...
    <!-- Tanggal Akhir -->
    <div class="relative">
        <input id="endDateLaporan" type="text" placeholder="Sampai" readonly
            class="border border-orange-400 px-3 py-1.5 rounded focus:outline-none cursor-pointer text-sm bg-white" />
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const startInput = document.getElementById("startDateLaporan");
        const endInput = document.getElementById("endDateLaporan");
        const noDataMessage = document.getElementById("noDataMessageLaporan");
