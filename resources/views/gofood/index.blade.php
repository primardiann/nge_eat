            ...
            <tbody class="text-gray-700 text-center text-sm">
                ...
                <tr
                    ...
                    <td class="px-6 py-3 max-w-[150px] relative group cursor-default">
                        <div class="truncate">
                            {{ $transaction->items->pluck('menu.name')->implode(', ') }}
                        </div>
                        <div
                    ...
                    <td class="px-6 py-3">
                        <div class="flex justify-center space-x-4 text-gray-500">
                            <button
                                ...
                                data-item="{{ $transaction->items->pluck('menu.name')->implode(', ') }}"
                            ...
                            <!-- Form Hapus -->
                            <form
                                action="{{ route('gofood.destroy', $transaction->id) }}"
                                method="POST"
