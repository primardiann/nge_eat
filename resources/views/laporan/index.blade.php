                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <form method="GET" action="" class="flex items-center m-0 p-0">
                            <select name="platform" onchange="this.form.submit()"
                                ...
                                <option value="gofood" {{ request('platform') === 'gofood' ? 'selected' : '' }}>GoFood
                                </option>
                                <option value="grabfood" {{ request('platform') === 'grabfood' ? 'selected' : '' }}>GrabFood
                                </option>
                                <option value="shopeefood" {{ request('platform') === 'shopeefood' ? 'selected' : '' }}>
                                    ShopeeFood</option>
                            </select>
                        </form>
                    </div>
